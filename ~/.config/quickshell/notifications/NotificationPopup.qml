            ...
            ColumnLayout {
              ...
              RowLayout {
                ...
                Item {
                  ...
                  Text {
                    ...
                    text: {
                      ...
                      if (notifCard.notifAppName.toLowerCase().includes("librewolf")) return "";
                ...
                Rectangle {
                  ...
                  height: 20
                  radius: 10
                  color: closeHover.containsMouse ? root.theme.textMuted : "transparent"
                  Layout.alignment: Qt.AlignVCenter
              ...
              RowLayout {
                ...
                Repeater {
                  ...
                  Rectangle {
                    ...
                    radius: 6
                    color: actionHover.containsMouse ? root.theme.bgBorder : root.theme.bgHover
